...
function addMarker(place)
{
    ...
    var img = "http://maps.google.com/mapfiles/kml/pal2/icon31.png";
   ...
   articles = "<u1>";
    ...
    for(var i=0;i<len;i++)
    {
    articles+= "<div><li> <a href=\""+content[i].link+"\"target = \"_blank\">"  +content[i].title+" </li> </div>";
    }
        articles+="</u1>";                   
...
function configure()
{
    ...
    $("#q").val(suggestion.place_name+','+suggestion.admin_name1);
    });
